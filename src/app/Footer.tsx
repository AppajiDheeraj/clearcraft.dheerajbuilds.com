  ...
  return (
    <section className="relative grid min-h-[125svh] grid-rows-[50svh_75svh] overflow-hidden bg-[#0f0f0f] sm:h-svh sm:min-h-0 sm:grid-rows-2" aria-label="Thank you and contact">
      ...
      <video
        ...
        playsInline
        preload="auto"
        poster="/waving-goodbye-alpha-v2.png"
        width={1080}
        height={1920}
        aria-label="Animated illustration of Dheeraj waving goodbye"
      >
      ...
      <footer className="relative z-20 grid h-full grid-cols-1 content-end gap-6 px-6 pb-8 pt-[30svh] justify-end text-neutral-50 sm:grid-cols-2 sm:content-center sm:items-center sm:gap-0 sm:px-10 sm:py-8 md:px-12">
        ...
        <div className="justify-self-center text-center sm:justify-self-start sm:text-left">
          <address className="grid w-max max-w-full not-italic">
            ...
            <a
              ...
              href="mailto:buildbydheeraj@gmail.com"
            >
              buildbydheeraj@gmail.com
            </a>
          ...
          <nav
            className="mt-6 flex items-center justify-center gap-5 sm:justify-start"
            aria-label="Social profiles"
          >
            {socials.map(({ label, href, Icon }) => (
              <a
                className="grid size-6 place-items-center text-white transition hover:text-neutral-300 focus-visible:rounded focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white"
                key={label}
                href={href}
                target="_blank"
                rel="noreferrer"
        ...
        <div className="justify-self-center text-center sm:justify-self-end">
          ...
          <p className="mt-8 whitespace-nowrap [font-family:var(--font-signature)] text-[clamp(2.5rem,5vw,4.5rem)] font-normal leading-none">
            Appaji Dheeraj
          </p>
        </div>
